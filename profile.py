...
<div class="row" style="position:sticky;top:4%;z-index:999;">
  ...
  <h5><a class="navbar-brand" href="profile.py">Home</a></h5>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item ">
       <h5> <a class="navbar-brand about" href="changepassword.py">Change Password</a></h5>
      </li>
       <li class="nav-item">
       <h5> <a class="navbar-brand" href="admin/logout.py">Logout</a></h5>
      </li>
    </ul>
...
<div class="row p-0">
<div class="col-sm-12 dd text-center" >
<a href="classes.py"><h2>show pdf</h2></a>
  </br>
  </br>
<a href="classes.py"><h2>show video</h2></a>
</div>
</div>
